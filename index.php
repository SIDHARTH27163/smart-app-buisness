...
<head>
  ...
  <link href="assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
    ...
    <meta name="google-site-verification" content="ybczJ4tIQmesr6TBLooCJAeP2fdKk7WF89AoIR0Yn8g" />
    <meta name="google-adsense-account" content="ca-pub-8644495705295739">
  <!-- Main CSS File -->
...
$sql = "SELECT logo_path, client_name, website_link FROM clients";
        ...
        <div class="container" data-aos="zoom-in">
            <div class="swiper init-swiper">
                ...
                <div class="swiper-wrapper align-items-center">
                    <?php
                    // Loop through the results and display each client logo and link
                    while ($row = $result->fetch_assoc()) {
                        ?>
                        <div class="swiper-slide">
                            <a href="<?php echo $row['website_link']; ?>" target="_blank">
                                <img src="./Admin/clients/<?php echo basename($row['logo_path']); ?>" class="img-fluid" alt="<?php echo $row['client_name']; ?>" style="height:40px ; " />
                            </a>
                        </div>
                        <?php
                    }
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            <p>
            Welcome to Lookin, where innovation meets excellence! We are a dedicated team of professionals committed to transforming your ideas into reality through cutting-edge technology and creative design. With a passion for delivering high-quality solutions.
            </p>
            <ul>
              <li><i class="bi bi-check2-circle"></i> <span>At Lookin, we tailor software solutions to meet your unique business needs. Our team collaborates closely with you to enhance efficiency and drive growth, leveraging the latest technologies to deliver custom applications and enterprise solutions that exceed expectations.</span></li>
              <li><i class="bi bi-check2-circle"></i> <span> In today's mobile world, a robust app is essential. Our experienced developers create user-friendly applications for both iOS and Android, focusing on intuitive design and seamless functionality. Whether it’s a simple app or a complex platform, we ensure an exceptional user experience.</span></li>
              <li><i class="bi bi-check2-circle"></i> <span>Visual identity is key to brand perception. Our skilled graphic designers create stunning visuals that communicate your message effectively. From logos to marketing materials, we understand your vision and deliver compelling designs that enhance your brand and drive results.</span></li>
            </ul>
          </div>

          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <p>At Lookin, we pride ourselves on our client-centric approach. We believe in building long-lasting relationships with our clients by providing exceptional service, timely communication, and ongoing support. Our goal is to become your trusted partner in navigating the digital landscape.

Our diverse team brings together expertise in technology, design, and project management, allowing us to tackle projects of any size and complexity. We are always on the lookout for new trends and technologies, ensuring that we stay ahead of the curve and deliver solutions that are not only innovative but also practical.

Join us at Lookin as we embark on a journey to create impactful digital experiences together. Let us help you take your business to the next level!</p>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center order-2 order-lg-1">
            ...
            <div class="content px-xl-5" data-aos="fade-up" data-aos-delay="100">
              <h3><span>Lookin</span><strong> cultivating and developing softwares</strong></h3>
              <p>
              At Lookin, we are dedicated to delivering exceptional quality and personalized service. Our experienced team combines technical expertise with creativity, ensuring tailored solutions that meet your specific needs. We prioritize client satisfaction and maintain transparent communication throughout the project lifecycle. With our commitment to innovation and excellence, we help you stay ahead in a competitive market. Choose Lookin as your trusted partner for software development, app development, and graphic design, and let us turn your ideas into reality!
              </p>
            </div>
            ...
            <div class="faq-container px-xl-5" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="faq-item faq-active">
                ...
                <h3><span>01</span> Expertise and Innovation</h3>
                <div class="faq-content">
                  <p>At Lookin, our team consists of skilled professionals who stay updated on the latest industry trends. We combine technical expertise with innovative solutions to deliver high-quality software, apps, and designs tailored to your business needs. Your success is our priority, driving us to continually push boundaries.</p>
                </div>
              ...
              <div class="faq-item">
                ...
                <div class="faq-content">
                  <p>We believe in building strong partnerships with our clients. At Lookin, we prioritize open communication and collaboration throughout the project lifecycle. By understanding your unique requirements, we deliver personalized solutions that not only meet but exceed your expectations, ensuring a seamless experience from start to finish.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3><span>03</span>Comprehensive Solutions</h3>
                <div class="faq-content">
                  <p>Lookin offers a full range of services, including software development, app development, and graphic design. Our holistic approach allows us to provide integrated solutions that enhance your brand and drive growth. Whether you need a custom app or eye-catching visuals, we have the expertise to bring your vision to life.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->
          ...
          <div class="col-lg-5 order-1 order-lg-2 why-us-img">
            <img src="assets/img/about.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="100">
          </div>
        </div>
